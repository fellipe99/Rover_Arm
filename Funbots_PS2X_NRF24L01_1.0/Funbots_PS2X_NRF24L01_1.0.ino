...
/*  
  // Recebe dados dos analógicos
  joystickData.potLY = mapJoystickValues( ps2x.Analog(PSS_LY), 0, 128, 1015, true );
  joystickData.potLX = mapJoystickValues( ps2x.Analog(PSS_LX), 0, 128, 1020, true );
  joystickData.potRY = mapJoystickValues( ps2x.Analog(PSS_RY), 0, 128, 1021, true );
  joystickData.potRX = mapJoystickValues( ps2x.Analog(PSS_RX), 0, 128, 1020, true );
*/
